	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							 ...
							 'font_size': {	"select":true,
						      ...
						      'italics'	: { "text":"I", 
											"icon":"aqil-icon-italic", 
											"tooltip":"Italics", 
											"commandname":"italic",
											"custom":null },

						     'underline': { "text":"U", 
											"icon":"aqil-icon-underline", 
											"tooltip":"Underline", 
						     ...
						     'l_align'	: { "text": "leftalign", 
											"icon": "aqil-icon-align-left", 
											"tooltip": "Align Left", 
											"commandname":"justifyleft", 
											"custom":null },

						     'r_align'	: { "text": "rightalign", 
											"icon": "aqil-icon-align-right", 
											"tooltip": "Align Right", 
											"commandname":"justifyright", 
											"custom":null },

						     'c_align'	: { "text": "centeralign", 
											"icon": "aqil-icon-align-justify", 
		    ...
		    editor.bind("contextmenu", function(e){
	       		...
	       		var cMenuUl = $('<ul/>',{ class:"drop-menu on","role":"menu"});
	       		e.preventDefault();
	       		if($(e.target).is('a')){
		...
		createMenuItem: function(itemSettings, options, returnElement){
			...
			if(itemSettings["select"]){
				var menuWrapElement = $("<div/>", {class:"drop"});
				var menuElement 	= $("<ul/>", {class:"drop-menu"});
				menuWrapElement.append($('<a/>',{
										class:"editor-btn ripple dropdown-toggle",
				...
				var menuWrapElement = $("<a/>",{href:'javascript:void(0)', class:'editor-btn ripple'});
				var menuElement = $("<i/>");
				if(itemSettings["icon"])
					menuElement.addClass(itemSettings["icon"]);
				else
